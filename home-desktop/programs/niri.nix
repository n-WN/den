  ...
  settings = {
    ...
    binds =
      ...
      with config.lib.niri.actions;
      {
        ...
        "Mod+O".action = spawn (lib.getExe' pkgs.kickoff "kickoff");
        ...
        "Mod+Shift+S".action = spawn "${pkgs.sway-contrib.grimshot}/bin/grimshot" "copy" "area";
            ...
            lib.getExe (
              pkgs.writeShellScriptBin "scale-switcher" ''
                ...
                if test "$current_scale" = "1.0"; then
                  ${niri} msg output DP-1 scale 2.0
                else
